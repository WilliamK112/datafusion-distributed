...
use crate::coordinator::dynamic_filters::prepare_dynamic_filter_plan_for_display;
...
pub struct DistributedExec {
    ...
    pub(crate) completed_dynamic_filter_store: Option<Arc<CompletedDynamicFilterStore>>,
}
...
impl DistributedExec {
    ...
    pub fn with_dynamic_filter_collection(mut self, enabled: bool) -> Self {
        self.completed_dynamic_filter_store = match enabled {
            true => Some(Arc::new(CompletedDynamicFilterStore::new())),
            false => None,
        };
        self
    }
    ...
    fn execute(
        ...
        builder.spawn(async move {
            ...
            let plan_for_viz = match collect_dynamic_filters {
                true => prepare_dynamic_filter_plan_for_display(result.plan_for_viz, &context)?,
