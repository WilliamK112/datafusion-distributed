...
pub mod coordinator_to_worker_msg {
    ...
    pub enum Inner {
        ...
        #[prost(message, tag = "4")]
        ApplyDynamicFilter(super::ApplyDynamicFilter),
    }
}
...
pub struct ApplyDynamicFilter {
    ...
    /// Serialized datafusion.proto.PhysicalExprNode containing the merged inner predicate.
    #[prost(bytes = "vec", tag = "2")]
    pub predicate_proto: ::prost::alloc::vec::Vec<u8>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
